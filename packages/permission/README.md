...
```typescript
import { IPermissionChecker, PermissionResult, PermissionManager } from '@caf/permission';
...
```typescript
import { PermissionManager, IPermissionChecker } from '@caf/permission';
...
```typescript
import { RoleBasedPermissionChecker } from '@caf/permission/role-based';
...
```typescript
import { PolicyBasedPermissionChecker } from '@caf/permission/policy-based';
import { PermissionManager } from '@caf/permission';
...
import { CaslPermissionChecker } from '@caf/permission/casl';
import { PermissionManager } from '@caf/permission';
...
- `RoleBasedPermissionChecker` — Adapter for role-based permissions (from `@caf/permission/role-based`)
- `PolicyBasedPermissionChecker` — Adapter for policy-based permissions (from `@caf/permission/policy-based`)
- `SimplePermissionChecker` — Adapter for simple permission lists (from `@caf/permission/simple`)
- `CaslPermissionChecker` — Adapter for CASL abilities (from `@caf/permission/casl`)
- `ResourceBasedPermissionChecker` — Adapter for resource-based permissions (from `@caf/permission/resource-based`)
- `HierarchicalPermissionChecker` — Adapter for hierarchical permissions with wildcards (from `@caf/permission/hierarchical`)
- `TimeBasedPermissionChecker` — Adapter for time-based permission constraints (from `@caf/permission/time-based`)
